...
export function PlayerBar() {
  ...
  return (
    <div className="relative border-t border-border bg-surface px-3 pb-1.5 pt-2">
      ...
      {/* Placement hors-écran (-9999px) : Chrome Android continue la lecture
          audio de l'iframe en arrière-plan dans ce cas. Ne PAS utiliser
          opacity-0 dans le viewport : Chrome gèle l'iframe → l'audio s'arrête.
          Le widget d'écran verrouillé est préservé par le store (pas de
          destruction du player sur pagehide + réassertion Media Session). */}
      <div
        className={
          showVideo
